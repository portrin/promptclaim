...
module.exports = class Policy {
    constructor({ policy_id = null, policy_period = null, policy_description = null, date_created = null, policy_owner_id = null } = {}) {
    ...
    _create() {
        ...
        return db.execute(
            ...
            [this._policyId, this._policyPeriod, this._policyDescription, this._dateCreated, this._policyOwnerId]
        );
    }
    ...
    _update() {
        return db.execute('UPDATE policy SET policy_period = ?, policy_description = ?, date_created = ?, policy_owner_id = ? WHERE policy_id = ?',
            [this._policyPeriod, this._policyDescription, this._dateCreated, this._policyOwnerId, this._policyId]);
    }
